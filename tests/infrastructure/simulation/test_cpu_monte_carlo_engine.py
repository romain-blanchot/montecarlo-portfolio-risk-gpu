...
class TestCpuMonteCarloEngineReproducibility:
    def test_seed_produces_same_result(self):
        ...
        r1 = CpuMonteCarloEngine(seed=123).simulate(
            model=model,
            initial_prices=(100.0,),
            num_simulations=10,
            time_horizon_days=21,
        )
        r2 = CpuMonteCarloEngine(seed=123).simulate(
            model=model,
            initial_prices=(100.0,),
            num_simulations=10,
            time_horizon_days=21,
    ...
    def test_different_seeds_produce_different_results(self):
        ...
        r1 = CpuMonteCarloEngine(seed=1).simulate(
            model=model,
            initial_prices=(100.0,),
            num_simulations=10,
            time_horizon_days=21,
        )
        r2 = CpuMonteCarloEngine(seed=2).simulate(
            model=model,
            initial_prices=(100.0,),
            num_simulations=10,
            time_horizon_days=21,
